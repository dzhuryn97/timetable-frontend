...
export default function Home() {
    ...
    return (
        <Box margin={"0 auto"} maxWidth={"500px"} display={"flex"} flexDirection={"column"}>
            <Heading textAlign={"center"} mb={"50px"}>Time Table</Heading>

            <FormControl mb={"10px"}>
                <Input placeholder='Search' value={inputSearchQuery} onChange={searchInputChangeHandler}/>
            </FormControl>
